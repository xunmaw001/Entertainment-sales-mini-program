            ...
            <view class="forget-card"
                ...
                <view class="forget-input forget-margin-b">
                    <input v-model="username"
                           :style='{"borderColor":"rgba(153, 0, 51, 1)","backgroundColor":"#fff","borderRadius":"0px","color":"rgba(0, 102, 51, 1)","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
                ...
                <view class="login-input login-margin-b">
                    <picker style="color: #888888;padding: 0 40upx;box-sizing:border-box;margin-top: 20upx;"
                        ...
                        <view class="uni-input"
                              :style='{"lineHeight":"80rpx","fontSize":"28rpx","color":"rgba(0, 102, 51, 1)","textAlign":"center"}'>
                            {{options[index]}}</view>
                    </picker>
                </view>
            </view>
