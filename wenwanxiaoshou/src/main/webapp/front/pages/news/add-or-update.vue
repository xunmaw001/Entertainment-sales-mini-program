		...
		<form class="app-update-pv">
            <view
                ...
                <input   readonly="readonly"
                         ...
                         :disabled="ro.newsName" type="text" v-model="ruleForm.newsName" placeholder="新闻名称"></input>
            </view>
                <view
            ...
            <view
                ...
                <textarea :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0, 102, 51, 1)","borderRadius":"0px","color":"rgba(0, 102, 51, 1)","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"28rpx","borderStyle":"solid","height":"200rpx"}'
                          :disabled="ro.newsContent" v-model="ruleForm.newsContent" placeholder="新闻详情"/>
            </view>
		...
		methods: {
			...
			async onSubmitTap() {
				if ((!this.ruleForm.newsName)) {
					this.$utils.msg(`新闻名称不能为空`);
					return
				}
				if ((!this.ruleForm.newsPhoto)) {
					this.$utils.msg(`新闻图片不能为空`);
					return
				}
				if (this.ruleForm.id) {
