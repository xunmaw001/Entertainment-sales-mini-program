			...
			<view class="detail-content">
				<view class="price detail-list-item priceFavor"
					...
					<view class="text" style="color: red;textAlign:left">
						<text style='font-size:20rpx'>¥</text><text style="font-weight:bold;font-size:50rpx">{{detail.goodsNewMoney}}</text><text style="font-size: 20rpx;color: #8799A3;margin-left: 10rpx;">原价￥<text style="text-decoration:line-through">{{detail.goodsOldMoney}}</text></text>
					</view>
				</view>
