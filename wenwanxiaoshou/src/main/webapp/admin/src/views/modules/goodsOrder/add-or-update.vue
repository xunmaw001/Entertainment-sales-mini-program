            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='goods'">
                    <el-form-item class="select" v-if="type!='info'"  label="商品信息" prop="goodsId">
                        <el-select v-model="ruleForm.goodsId" filterable placeholder="请选择商品信息" @change="goodsChange">
                            <el-option
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="订单类型" prop="goodsOrderTypes">
                        <el-select v-model="ruleForm.goodsOrderTypes" placeholder="请选择订单类型">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="支付类型" prop="goodsOrderPaymentTypes">
                        <el-select v-model="ruleForm.goodsOrderPaymentTypes" placeholder="请选择支付类型">
                            <el-option
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='goodsOrderTruePrice'){
                          this.ruleForm.goodsOrderTruePrice = obj[o];
                          this.ro.goodsOrderTruePrice = true;
                          continue;
                      }
                      if(o=='goodsOrderTypes'){
                          this.ruleForm.goodsOrderTypes = obj[o];
                          this.ro.goodsOrderTypes = true;
                          continue;
                      }
                      if(o=='goodsOrderPaymentTypes'){
                          this.ruleForm.goodsOrderPaymentTypes = obj[o];
                          this.ro.goodsOrderPaymentTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
